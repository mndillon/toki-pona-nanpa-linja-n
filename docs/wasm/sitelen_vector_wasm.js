/* @ts-self-types="./sitelen_vector_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function vectorize_run(font_bytes, request_js) {
    const ptr0 = passArray8ToWasm0(font_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.vectorize_run(ptr0, len0, request_js);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sitelen_vector_wasm_bg.js": import0,
    };
}
